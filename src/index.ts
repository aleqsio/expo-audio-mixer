...
export function setVolume(
  firstTrackVolume: number,
  secondTrackVolume: number
): string {
  return ExpoAudioMixerModule.setVolume(firstTrackVolume, secondTrackVolume);
}

export function setPan(firstTrackPan: number, secondTrackPan: number): string {
  return ExpoAudioMixerModule.setVolume(firstTrackPan, secondTrackPan);
}
